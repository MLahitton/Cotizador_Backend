...
public sealed record StructuredItemData(
    ...
    string? Ai2ElementId = null,
    string? Arrangement = null,
    string? RequestedSystemRaw = null,
    string? RequestedProfileRaw = null,
    string? GlassTypeRaw = null,
    string? GlassTypeNormalized = null,
    decimal? GlassThicknessMm = null,
    string? GlassColorRaw = null,
    string? GlassColorNormalized = null,
    string? GlassTreatmentRaw = null,
    string? GlassTreatmentNormalized = null,
    string? GlassComposition = null,
    string? GlassCoating = null,
    string? GlassTransparency = null,
    string? FinishRawDescription = null,
    string? FinishNormalizedType = null,
    string? FinishColorRaw = null,
    string? FinishColorNormalized = null,
