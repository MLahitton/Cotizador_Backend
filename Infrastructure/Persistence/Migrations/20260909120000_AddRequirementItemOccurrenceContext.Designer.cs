...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909120000_AddRequirementItemOccurrenceContext")]
    partial class AddRequirementItemOccurrenceContext
    {
            ...
            modelBuilder.Entity("Domain.PreQuotes.RequirementPricingSnapshot", b =>
                {
                    ...
                    b.Property<long>("TechnicalProposalCommercialRevision")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1L)
            ...
            modelBuilder.Entity("Domain.PreQuotes.RequirementTechnicalProposal", b =>
                {
                    ...
                    b.Property<long>("CommercialRevision")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(1L)
            ...
            modelBuilder.Entity("Domain.PreQuotes.RequirementTechnicalProposalItem", b =>
                {
                    ...
                    b.Property<int?>("BaseHeightMillimeters")
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("BaseWidthMillimeters")
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("InclusionState")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)")
                    ...
                    b.HasIndex("ExcludedByUserId")
                        .HasDatabaseName("ix_requirement_technical_proposal_items_excluded_by_user_id");
                    ...
                    b.HasIndex("TechnicalProposalId", "Sequence")
                        .IsUnique()
                        .HasDatabaseName("ux_requirement_technical_proposal_items_proposal_sequence");
                    ...
                    b.ToTable("requirement_technical_proposal_items", "core", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_requirement_technical_proposal_items_source_extracted_item", "(\"source\" = 'AiExtracted' AND \"requirement_extracted_item_id\" IS NOT NULL) OR (\"source\" = 'Manual' AND \"requirement_extracted_item_id\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.PreQuotes.RequirementTechnicalProposalItem", b =>
                {
                    b.HasOne("Domain.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("ExcludedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
